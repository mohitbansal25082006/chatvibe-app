...
type BotEditScreenNavigationProp = StackNavigationProp<RootStackParamList, 'BotEdit'>;
type BotEditScreenRouteProp = RouteProp<RootStackParamList, 'BotEdit'>;
...
export const BotEditScreen: React.FC = () => {
  ...
  const { bots, updateBot } = useChat();
  const navigation = useNavigation<BotEditScreenNavigationProp>();
  const route = useRoute<BotEditScreenRouteProp>();
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        >
          <Text style={styles.headerTitle}>Edit Bot</Text>
          <Text style={styles.headerSubtitle}>Customize your AI companion</Text>
        </LinearGradient>
